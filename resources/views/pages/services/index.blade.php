...
<div class="pt-32 md:pt-40 pb-24 bg-gray-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16 md:mb-24" data-aos="fade-down">
            <h2 class="text-blue-600 font-bold uppercase mb-4 text-[10px] md:text-sm tracking-widest">Layanan OVI Petshop</h2>
            <h1 class="text-3xl md:text-6xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight px-4">Layanan Kami</h1>
            ...
            <p class="text-gray-500 text-base md:text-xl max-w-2xl mx-auto font-medium px-4">
                Informasi layanan dan bantuan dari OVI Petshop untuk kebutuhan hewan peliharaan Anda.
            </p>
        </div>
                ...
                @foreach($services as $index => $service)
                    ...
                    >
                        ...
                        <div class="p-8 md:p-12">
                            ...
                            <a href="{{ route('services.show', $service->slug) }}" class="inline-flex items-center gap-3 md:gap-4 text-gray-900 font-bold hover:gap-5 md:hover:gap-6 transition-all text-xs md:text-sm group/btn">
        ...
        @else
            <div class="text-center py-40 bg-white rounded-[5rem] shadow-2xl shadow-gray-200/50 border border-gray-100" data-aos="zoom-in">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-4">Belum Ada Layanan</h3>
                <p class="text-gray-400 text-lg">Kami sedang memperbarui informasi layanan. Silakan cek kembali nanti.</p>
            </div>
        @endif
        ...
        <div class="mt-24 md:mt-32 bg-blue-600 rounded-3xl md:rounded-[4rem] p-8 md:p-20 text-center relative overflow-hidden group" data-aos="zoom-in">
            ...
            <div class="relative z-10">
                <h2 class="text-white/80 font-bold uppercase mb-4 md:mb-6 text-[10px] md:text-sm tracking-widest leading-relaxed px-4">Masih ada pertanyaan?</h2>
                <h1 class="text-3xl md:text-6xl font-bold text-white mb-8 md:mb-12 leading-tight px-4">Kami siap membantu kebutuhan <br class="hidden md:block">hewan peliharaan Anda</h1>
                <div class="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 px-4">
                    <a href="{{ $whatsappLink }}" class="bg-white text-blue-600 px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-bold hover:scale-105 transition-transform active:scale-95 shadow-xl text-sm md:text-base">
                        Tanya via WhatsApp
                    </a>
